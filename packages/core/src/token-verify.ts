...
export class TokenVerifier {
  ...
  async #checkRevocation(jti: string): Promise<void> {
    ...
    const revokePayload = await parseJsonResponse(response);
    if (!revokePayload || typeof revokePayload !== "object") {
